...
<div className="flex justify-center gap-3 my-3">
  <input name="mode"checked={mode==="title"}  onSelect={()=>{setMode("title")}} type="radio" className="radio radio-primary" /> Search in Title
  <input name="mode" checked={mode==="full"} onSelect={()=>{setMode("full")}}  type="radio" className="radio radio-primary" defaultChecked/> Search Full Document
</div>
