...
<div className="flex justify-center gap-3 my-3">
  <input onSelect={()=>{setMode("title")}} type="radio" name="radio-4" className="radio radio-primary" defaultChecked/> Search in Title
  <input onSelect={()=>{setMode("full")}}  type="radio" name="radio-4" className="radio radio-primary" /> Search Full Document
</div>
