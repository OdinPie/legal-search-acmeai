    ...
    <div className="my-2">
      ...
      >
        {value.map(tag => (
          <span
            key={tag}
            className="inline-flex items-center gap-1 rounded-full bg-blue-50 text-blue-800 border border-blue-200 badge text-sm"
          >
            {tag}
            <button
              onClick={() => removeTag(tag)}
              className="btn btn-xs btn-circle rounded-full hover:!bg-red-100"
            >
              ✕
            </button>
          </span>
