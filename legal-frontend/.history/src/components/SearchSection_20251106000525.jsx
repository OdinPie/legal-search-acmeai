...
<div className="flex justify-center gap-3 my-">
  <input type="radio" name="radio-4" className="radio radio-primary" />  Title
<input type="radio" name="radio-4" className="radio radio-primary" /> Anywhere
</div>
