...
export default function SearchSection() {
  ...
  const searchQuery = () =>{
    ...
    .catch(() =>{
      setError("Something went wrong. Kindl try again later.")
    })
...
<div className="flex justify-center gap-3 my-3">
  ...
  {docs ? <DisplayCards value={docs}></DisplayCards>
  :
  <div>
    <button className="btn btn-secondary">See All Documents</button>
  </div>
  }
    </div>
  );
